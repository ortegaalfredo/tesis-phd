...
# set terminal fig monochrome small pointsmax 1000 landscape inches dashed textnormal font "Times Roman,10" linewidth 1 depth 10 version 3.2
# set output './BER-tesis.fig'
unset clip points
set clip one
unset clip two
...
GNUTERM = "wxt"
plot "./BER-8bits-optical.dat" title 'BER 8-bits con ruido optico' w lp ls 3,"./BER-16bits.dat" title 'BER 16-bits' w linesp ls 2, "./BER-8bits-128clientes.dat" title 'BER 8-bits' w linesp ls 1
#    EOF
