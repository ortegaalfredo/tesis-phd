...
set xlabel "Probabilidad de error" 
set xlabel  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set x2label "" 
set x2label  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set xrange [ * : * ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
set ylabel "Capacidad del canal" 
...
GNUTERM = "wxt"
plot "grafico_comparacion_capacidad_binaria_z.dat" using 1:2 w linesp title "Canal simetrico", "grafico_comparacion_capacidad_binaria_z.dat" using 1:3 w linesp title "Canal Z"
#    EOF
