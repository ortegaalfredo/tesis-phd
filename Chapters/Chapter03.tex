...
Un canal de comunicaciones puede clasificarse primeramente segun el tipo de información transmitida, sea binaria o analógica, por lo cual tendremos canales binarios o analógicos [TODO:CITA].
Una sub-clasificación del canal de comunicación es segun el comportamiento del ruido del mismo.
