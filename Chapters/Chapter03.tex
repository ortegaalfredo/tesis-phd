...
La pila de codificación se detalla en la figura \ref{fig_stack} donde puede apreciarse un arreglo convencional, excepto que en la ultima etapa de correccion de errores se aplica el algoritmo de Bloom filters, que es la etapa que optimiza la corrección de errores convencional (Reed Solomon).
