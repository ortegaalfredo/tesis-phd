...
\begin{figure}[!t]
   \centering
   \subfloat[Señal con 256 unos por frame (8B/10B), 400 ps por bit]{{\includegraphics[width=0.45 \textwidth]{graphs/expansion1.jpg} }}%
   \qquad
   \subfloat[Señal con 48 unos por frame, 1100 ps por bit]{{\includegraphics[width=0.45 \textwidth]{graphs/expansion2.jpg} }}%
   \qquad
