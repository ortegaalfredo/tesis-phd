...
\caption {Se detalla la expansión del tiempo de bit (en picosegundos) en una señal desbalanceada a medida que la cantidad de unos por trama va disminuyendo. El tamaño de la trama es de 512 bits, por lo que son necesarios 256 bits en uno para lograr una señal perfectamente balanceada. La tasa nominal en este caso es de 2.5 Gbps, por lo que el ancho de bit normal es 400 ps.}
