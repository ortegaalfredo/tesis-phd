...
\begin{enumerate}
 \item El iniciante envía el prefijo de sincronización y este es detectado por el módulo de alineación del receptor. Este módulo alinea a nivel de bit y byte, o sea que garantiza que en el buffer de salida de 32 bits, el prefijo aparece en el bit 0, 8, 16 o 24.
 \item Una vez alineado el prefijo en el buffer de salida, solo resta detectar en qué posicion ha quedado y comenzar a leer el frame desde la posición siguiente. Esto se realiza en el código verilog sintetizando cuatro detectores que simultaneamente testearan por cada posición y deciden en un solo reloj cual es la alineación correcto. Al ser solo 4 posiciónes posibles, es una solución eficiente.
\end{enumerate}
