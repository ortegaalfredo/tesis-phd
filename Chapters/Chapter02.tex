...
\begin{figure}[t]
  ...
  \caption{Comparación gráfica entre las separaciones de canal en TDMA (\textit{Time Division Multiple Access}), FDMA (\textit{Frequency Division Multiple Access}) y CDMA (\textit{Code Division Multiple Access})}
  \label{fig_tdmacdma}
\end{figure}
