...
\section{Minimización del peso de Hamming}
\frame{\tableofcontents[currentsection,hideallsubsections]}
...
\framesubtitle{Origen de la técnica}
  ...
  $$HW(00100000) = 1$$
  \item La minimización del HW es una representación o codificación numérica alternativa.
  \end{itemize}
}
